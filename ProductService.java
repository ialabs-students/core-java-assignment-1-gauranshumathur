...
public class ProductService {
	...
	public static void main(String[] args) {
		...
		System.out.println(product.findMaxPriceProduct("sports"));
		System.out.println(product.findMaxPriceProduct("grocery"));
		System.out.println(product.findMaxPriceProduct("grocery"));
		System.out.println(product.getProductsByCategory("sports"));
		System.out.println(product.getProductsByCategory("wearables"));
		System.out.println(product.getProductsByCategory("wearables"));
	}
